...
$pageSize = $_GET['pageSize'] ?? 5; // Cantidad de elementos por página
...
$sql = "SELECT * FROM trabajos LIMIT $offset, $limit";
$result = mysqli_query($con, $sql);

// Obtener el total de registros sin paginación
$total = mysqli_num_rows(mysqli_query($con, "SELECT * FROM trabajos"));
